  ...
  if (reason.length < 1)
    return message.reply("<a:hata1:831855888007954453> Ban sebebini yazmalısın.").then(m => m.delete(3000));
  if (message.mentions.users.size < 1)
    return message
      .reply("<a:hata1:831855888007954453> Kimi banlayacağını yazmalısın.")
      .catch(console.error)
      .then(m => m.delete(3000));
  if (!message.guild.member(user).bannable)
    return message.reply("<a:hata1:831855888007954453> Yetkilileri banlayamam.").then(m => m.delete(3000));
