...
exports.run = async (bot, msg, args) => {
        ...
        .replace("dnd", `<:dnd:834797471921602620>  | **Rahatsız Etmeyin**`)
        .replace("online", `<:aktif:834797656181309440>  | **Çevrimiçi**`)
        .replace("idle", `<:bota:834798092066619422>  | **Boşta**`)
        .replace("offline", `<:ofline:834798088480489542>  | **Çevrimdışı**`)
        ...
        .setFooter(`Stoplazma | Kullanıcı Bilgi Sistemi`)
